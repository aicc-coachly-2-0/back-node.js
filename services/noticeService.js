...
// 공지글 작성 (사진 포함)
exports.createNoticeWithImages = async ({ admin_number, title, content, images }) => {
    const notice = await noticeModel.insertNotice({ admin_number, title, content });
...
// 공지글 수정
exports.updateNotice = async (noticeNumber, noticeData) => {
  return await noticeModel.updateNotice(noticeNumber, noticeData);
};
