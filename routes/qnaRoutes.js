...
// 특정 유저 질문 조회
router.get('/users/:user_number/questions', questionController.getQuestionsByUser);
...
// 답변 조회 (질문별)
router.get('/questions/:question_number/answers', answerController.getAnswersByQuestion);
